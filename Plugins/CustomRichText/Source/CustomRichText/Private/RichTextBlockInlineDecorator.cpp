...
namespace RichTextBlockInlineDecorator
{
	static const FString TriggerWord = TEXT("span");
	static const FString FontMetaWord = TEXT("font");
	static const FString SizeMetaWord = TEXT("size");
	static const FString StyleMetaWord = TEXT("style");
	static const FString ColorMetaWord = TEXT("color");
}
...
{
	return (RunParseResult.Name == RichTextBlockInlineDecorator::TriggerWord);
}
...
void FDefaultRichTextDecorator::ExplodeRunInfo(const FRunInfo& InRunInfo, FSlateFontInfo& OutFont, FLinearColor& OutFontColor) const
{
	...
	const FString* FontFamilyString = InRunInfo.MetaData.Find(RichTextBlockInlineDecorator::FontMetaWord);
	const FString* FontSizeString = InRunInfo.MetaData.Find(RichTextBlockInlineDecorator::SizeMetaWord);
	const FString* FontStyleString = InRunInfo.MetaData.Find(RichTextBlockInlineDecorator::StyleMetaWord);
	const FString* FontColorString = InRunInfo.MetaData.Find(RichTextBlockInlineDecorator::ColorMetaWord);
